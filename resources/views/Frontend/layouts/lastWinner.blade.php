        ...
        <div class="row wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">
            <div class="col-lg-12">
                {{-- <ul class="nav nav-tabs winner-tab-nav" id="winnerTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="bike-tab" data-toggle="tab" href="#bike" role="tab" aria-controls="bike"
                            aria-selected="false">
                            ...
                            <div class="col-lg-8 mb-30">
                                <div class="winner-card mb-30">
                                    ...
                                    <div class="winner-card__content">
                                        <div class="winner-thumb"><img src="assets/images/winner/1.png" alt="image">
                                        </div>
                                ...
                                <div class="winner-card mb-30">
                                    ...
                                    <div class="winner-card__content">
                                        <div class="winner-thumb"><img src="assets/images/winner/2.png" alt="image">
                                        </div>
                                        <div class="content-top">
                                            <div class="left">
                                                <h5>The Breeze Zodiac IX</h5>
                                ...
                                <div class="winner-card mb-30">
                                    ...
                                    <div class="winner-card__content">
                                        <div class="winner-thumb"><img src="assets/images/winner/3.png" alt="image">
                                        </div>
                                        <div class="content-top">
                                            <div class="left">
                                                <h5>The Breeze Zodiac IX</h5>
                                ...
                                <div class="winner-card mb-30">
                                    ...
                                    <div class="winner-card__content">
                                        <div class="winner-thumb"><img src="assets/images/winner/4.png" alt="image">
                                        </div>
                                        <div class="content-top">
                                            <div class="left">
                                                <h5>The Breeze Zodiac IX</h5>
                                ...
                                <div class="winner-card mb-30">
                                    ...
                                    <div class="winner-card__content">
                                        <div class="winner-thumb"><img src="assets/images/winner/5.png" alt="image">
                                        </div>
                                        <div class="content-top">
                                            <div class="left">
                                                <h5>The Breeze Zodiac IX</h5>
                                ...
                                <div class="winner-card mb-30">
                                    ...
                                    <div class="winner-card__content">
                                        <div class="winner-thumb"><img src="assets/images/winner/6.png" alt="image">
                                        </div>
                                        <div class="content-top">
                                            <div class="left">
                                                <h5>The Breeze Zodiac IX</h5>
                                ...
                                <div class="btn-grp">
                                    <a href="{{ URL::route('winners') }}" class="btn-border">browse more</a>
                                </div>
                            </div>
                        </div>
                    </div>
